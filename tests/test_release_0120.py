...
assert '// @version      0.0.12.0' in patch
assert 'ChatHarbor-IntegratedSync-0.0.12.0.user.js' in prepare
...
assert 'global backend 429 cooldown' in core
assert "record.attachment_state = 'partial'" in core
assert 'onItemFailed' in core
print('PASS 0.0.12.0 release/build invariants')
