...
if (-not $python) {
    ...
    & $python.Source -3 (Join-Path $Root 'tests\test_ui_0112.py')
} else {
    & $python.Source (Join-Path $Root 'tests\test_ui_0112.py')
}
...
Write-Host 'All ChatHarbor 0.0.11.2 automated regressions passed.' -ForegroundColor Green
